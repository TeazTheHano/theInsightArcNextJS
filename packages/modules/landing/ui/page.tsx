...
import { BlogItemContract as BlogItemProps } from '@/packages/modules/blog';
const placeholderData: BlogItemProps[] = [

    {
        id: '1', title: 'Coming soon', description: 'Coming soon', coverImage: '/placeholder',
    },
    {
        id: '2', title: 'Coming soon2', description: 'Coming soon2', coverImage: '/placeholder',
    },
    {
        id: '3', title: 'Coming soon3', description: 'Coming soon3', coverImage: '/placeholder',
    }
] as BlogItemProps[];
import { BlogSquareItemGen, useBlogs } from '@/packages/modules/blog'
...
function LandingPage() {
    ...
    useEffect(() => {
        if (allBlogs) {
            const sortedByTime = [...allBlogs].sort((a, b) => {
                const dateA = a.timeStamp ? new Date(a.timeStamp).getTime() : 0;
                const dateB = b.timeStamp ? new Date(b.timeStamp).getTime() : 0;
                return dateB - dateA;
            });

            setBlogData(sortedByTime.slice(0, 3) || (placeholderData as unknown as BlogItemProps[]));
        }
    }, [allBlogs]);
            ...
            <DivFlexColumn
                ...
                <DivFlexRow className='shiftVerticalSm shiftVerticalMd' style={{ gap: `var(--Spacing-Spacing-M, 24px)`, flex: 1 }}>
                    ...
                    <DivFlexColumn style={{ gap: `var(--Spacing-Spacing-M, 24px)`, flex: 1 }}>
                        ...
                        <BlogItem2RowGen dataList={(placeholderData as unknown as BlogItemProps[])} compactMode />
                    </DivFlexColumn>
                </DivFlexRow>
            </DivFlexColumn>
